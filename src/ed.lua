...
syntax_colors = {}
syntax_colors["to"]		=	{t="b", c={211,54,130}}
syntax_colors["end"]	=	{t="r", c={211,54,130}}
syntax_colors["make"]	=	{t="r", c={108,113,196}}
syntax_colors["for"]	=	{t="r", c={133,153,0}}
syntax_colors["if"]		=	{t="r", c={42,161,152}}
syntax_colors["ifelse"]	=	{t="r", c={42,161,152}}
syntax_colors["until"]	=	{t="r", c={133,153,0}}
syntax_colors["while"]	=	{t="r", c={133,153,0}}
syntax_colors["do.until"]=	{t="r", c={133,153,0}}
syntax_colors["do.while"]=	{t="r", c={133,153,0}}
syntax_colors["thing"]	=	{t="r", c={108,113,196}}
...
function Editor.paint(gc)
	...
	for ln=start,#lines do
		...
		for wi_, word in pairs(words) do
			if syntax_colors[word] then
				gc:setColorRGB(unpack(syntax_colors[word].c))
				gc:setFont("sansserif",syntax_colors[word].t,10)
			else
				gc:setFont("sansserif","r",10)
				gc:setColorRGB(0,0,0)
			end
